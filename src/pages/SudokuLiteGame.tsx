  ...
  return (
    <PageWrapper>
      {won ? (
        <div className="min-h-screen overflow-x-hidden">
          ...
          <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
            <div className="bg-white rounded-[40px] p-10 text-center shadow-2xl w-[90%] max-w-md animate-[popup_0.4s_ease] dark:bg-gray-600">
              ...
              <h1 className="text-5xl font-black text-green-600 mb-6 dark:text-white">
                Sudoku Solved!
              </h1>
        ...
        <div className="min-h-screen pb-6 md:pb-8 bg-gradient-to-b from-purple-400 via-blue-300 to-cyan-200 flex items-center justify-center p-6 dark:from-gray-900 dark:via-gray-900 dark:to-black">
          <div className="bg-white rounded-[40px] shadow-2xl p-4 md:p-8 w-full max-w-2xl text-center dark:bg-gray-700">
            {/* Title */}
            ...
            {/* Goal */}
            <div className="text-xl font-bold text-green-600 mb-2 dark:text-white">
            ...
            {gameOver && (
              <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
                <div className="bg-white rounded-[40px] p-10 text-center shadow-2xl w-[90%] max-w-md dark:bg-gray-600">
                  <div className="text-7xl mb-4">😢</div>

                  <h1 className="text-5xl font-black text-red-500 mb-6 dark:text-white">
                    Game Over
                  </h1>

                  <p className="text-xl font-bold text-gray-600 mb-8 dark:text-white">
                    You lost all hearts!
                  </p>
