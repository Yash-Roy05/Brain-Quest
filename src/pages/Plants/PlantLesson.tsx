...
export default function PlantLesson() {
  ...
  const allPartsVisited =
    visitedParts.includes("Root") &&
    visitedParts.includes("Stem") &&
    visitedParts.includes("Leaf") &&
    visitedParts.includes("Flower");
    ...
    <div className="min-h-screen bg-gradient-to-r from-green-400 to-emerald-500 p-4 md:p-6 pb-24 md:pb-24">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-white text-lg mt-0 md:mt-2">
        ...
        <div className="max-w-5xl mx-auto mt-6">
          ...
          <div className="relative w-full max-w-5xl mx-auto h-[700px]">
            ...
            <button
              ...
              className={` absolute -translate-y-1/2 p-2 z-20 w-[70px] h-[70px] top-[140px] left-[20px] md:w-[150px] md:h-[150px] md:top-[180px] md:left-[130px] ${selectedPart === "Stem" ? "drop-shadow-[0_0_25px_rgba(255,255,0,1)] scale-110 transition-all duration-300" : "transition-all duration-300"} `}
            >
              {" "}
              <img
                src={stemImg}
  ...
  "
          >
            <div className="flex items-center gap-1">
              ...
              <div>
                <h3 className="font-black text-green-700 text-2xl">Quester</h3>
              </div>
            </div>
