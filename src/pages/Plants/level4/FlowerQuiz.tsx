...
import { flowerQuizData } from "./flowerQuizData.ts";

export default function FlowerQuiz() {
  ...
  const currentQuestions = reviewMode ? wrongQuestions : flowerQuizData;
  ...
  "
    ...
    "
        >
          ...
          <p className="text-gray-600">Flowers need practice too</p>
...
"
        >
          ...
          <p className="text-xl mt-2">Flower Lesson Completed</p>
...
"
          >
            ...
            <div className="text-3xl font-black text-yellow-700">
              {Math.round((correctCount / flowerQuizData.length) * 100)}%
            </div>
        ...
        {!reviewMode && (
          <div className="w-full bg-gray-200 h-4 rounded-full mb-6">
            <div
              ...
              style={{
                width: `${(currentQuestion / flowerQuizData.length) * 100}%`,
              }}
            />
          </div>
        )}
